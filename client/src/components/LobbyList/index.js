            ...
            <div className="flex flex-row flex-wrap justify-evenly">
                ...
                {data.lobbies &&
                    data.lobbies.map((lobby) => {
                        const data = { lobby }
                        return (
                            <div className="h-40 w-[40%] mb-5 rounded-2xl relative" key={lobby._id}>
                                <Link className=""
                                    ...
                                    <div className="flex flex-col place-content-end h-3/4 text-white p-2 pb-5">
                                        <p className="flex justify-between mx-5 min"><b>Created By:</b> <span className="capitalize">{lobby.host}</span></p>
